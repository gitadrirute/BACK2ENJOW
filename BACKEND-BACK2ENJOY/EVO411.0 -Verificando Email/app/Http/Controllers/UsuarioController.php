...
class UsuarioController extends Controller
{
    ...
    public function validarUsuario($id){
     ...
     public function todosUsuariosConOSinFotos(){
        ...
        ->leftJoin('galeria_usuarios', 'usuarios.id', '=', 'galeria_usuarios.usuario_id')
        ->select('usuarios.id','usuarios.nombre', 'usuarios.apellidos', 'usuarios.nombreUsuario', 'usuarios.validado', 'galeria_usuarios.rutaImagen')
        ->get();
        

    $data = [
        'mensaje' => 'Usuarios con su foto perfil',
        'usuario' => $usuarios
